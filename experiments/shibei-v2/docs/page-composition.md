...
1. 首页点击开始节点进入章节概要页。
2. 章节概要页继续进入第一个知识点开场页。
3. 知识点开场页继续进入该知识点第一题。
4. 每道题作答后显示反馈状态和反馈浮窗，用户点击继续进入下一题。
5. 当前知识点所有题完成后进入单元总结页。
6. 如果还有下一个知识点，单元总结页继续进入下一个知识点开场页。
7. 如果这是章节最后一个知识点，单元总结页继续进入章节总结页。
8. 章节总结页可返回主页，也可查看章节详情。
