...
- **生成来源**：`knowledgeModel` 阶段生成；当前可先由 `reviewPathPlan` 兼容生成，后续拆成独立阶段。
- **前端使用位置**：默认不展示。
- **展示规则**：不进入正式 UI。
...
- **生成来源**：`unitLearningClaims` 或后续合并的 ECD planning 阶段生成。
- **前端使用位置**：默认不展示。
- **展示规则**：不进入正式 UI。
...
- **生成来源**：`unitEvidenceNeeds` 或后续合并的 ECD planning 阶段生成。
- **前端使用位置**：默认不展示。
- **展示规则**：不进入正式 UI。
...
- **ECD 对应**：`Task Model`。
- **生成来源**：`unitTaskPlan` 或后续合并的 ECD planning 阶段生成。
- **前端使用位置**：默认不展示。
- **展示规则**：不进入正式 UI。
...
- **生成来源**：`unitAssemblyPlan` 或后续合并的 ECD planning 阶段生成。
- **前端使用位置**：默认不展示。
- **展示规则**：不进入正式 UI。
