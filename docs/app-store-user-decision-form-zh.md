...
| 决策项 | 推荐选择 | 最终选择 | 影响范围 |
| --- | --- | --- | --- |
| 首版价格 | 免费 | 待填写 | App Store 价格、审核备注、产品页文案 |
| 首版是否启用 IAP/订阅 | 不启用 | 待填写 | App Store 商业化配置、审核复杂度 |
| 每日真实 AI 生成额度 | 每天 5 篇，按 UTC day | 待填写 | 后端额度、App 内提示、隐私政策、审核备注 |
| 推荐好文是否计入额度 | 不计入 | 待填写 | 新用户体验、额度说明、审核备注 |
| 匿名用户是否可直接生成 | 可以，不强制登录 | 待填写 | 首次体验、账号说明、审核备注 |

## 2. 账号与数据恢复决策

| 决策项 | 推荐选择 | 最终选择 | 影响范围 |
| --- | --- | --- | --- |
| 首版是否加入可选 Apple 登录 | 加入可选 Apple 登录 | 待填写 | 账号删除、隐私政策、App Review、前端入口 |
| 如果首版暂不做 Apple 登录，是否接受匿名数据恢复边界 | 不适用：首版做 Apple 登录；匿名模式仍需说明恢复边界 | 待填写 | 隐私政策、账号说明、审核备注 |
...
| Subtitle | 把文章变成练习题 | 待填写 |
| Promotional Text | 把文章、长文和好内容变成知识点与练习题，让阅读真正变成可以继续学习的进度。 | 待填写 |
| Category | Education | 待填写 |
| Secondary Category | Productivity | 待填写 |
| Keywords | 见 `docs/app-store-metadata-zh.md` | 待填写 |
