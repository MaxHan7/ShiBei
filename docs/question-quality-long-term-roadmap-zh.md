...
截至 2026-05-31，出题系统已经从“题量不足、知识点无题”推进到“文章结构绑定基本可诊断，但教学质量仍需校准”的阶段。

在 `UMr6ia1QubqOMw3aBUGbOw` 单篇基准上，最新已记录结果显示：

- 文章结构已经升级为“主线节点 + 证据子节点”两层。
- 代表性最新有效 run 保留 7 个知识点、20 道题，平均每知识点 2.9 道题。
- 6 / 7 个知识点达到 3 道题，所有知识点至少有 2 道入池题。
- 低置信题为 18 道，低置信比例 90.0%。
- 平均来源精准度达到 4.9，平均来源最小化达到 4.9。
- 平均主张忠实度达到 4.9，但平均来源覆盖仍只有 3.6。
- 主线节点从 v9 的 24 个伪结构节点压缩到 13 个，且关键知识点能绑定到对应主线。

这说明：**题量覆盖和来源定位已经不是第一瓶颈。当前主要矛盾转移到文章结构驱动下的教学质量：知识点是否稳定覆盖主线，题目是否覆盖所需证据链，解释、误区和干扰项是否真正帮助用户理解。**

因此当前最近主线调整为：**主线覆盖校准 + 低置信人工校准 + 解释一致性 / 边界误区专项**。后续不再把“每点 3 题”当作最高目标，而是把“每个知识点是否来自文章主线、每组题是否形成核心回忆、边界辨析、场景迁移的递进练习”作为第一验收口径。
