...
function summarize(output, status) {
  ...
  const readyLine = lines.find((line) => /Overall status:|readiness:|App Store submission readiness:|Production acceptance:|Production health:|Static pages readiness:/.test(line));
